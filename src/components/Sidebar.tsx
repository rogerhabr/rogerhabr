...
export default function Sidebar({ sections, active, onSelect }: SidebarProps) {
  let lastGroup = '';

  return (
    <aside className="fixed top-0 left-0 w-64 h-screen bg-sa-surface border-r border-sa-border flex flex-col z-20">
